...
After the data for the dungeon is done being generated, the actual assets will be placed. It does this by making a tilemap of the rooms and doors, and then using marching squares for the walls and flood-fill, originating from the starting room, to generate the floor. The interior of the rooms is made by selecting on which sides counters should be placed, and when placing them, checking if it would be too close to any door.
...
[GitHub repository ->](https://github.com/DeGekkeLamas/DiningDungeons) 
