...
Things I learned:
- Saving and reading data to and from JSON format. 
- Exporting a procedural file to a custom location and opening it back. 
- Making systems that are resistant to any errors. 
